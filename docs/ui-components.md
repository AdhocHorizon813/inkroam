...
.appearance-dock                 fixed 右下角
  ...
  .appearance-panel              面板本体（关闭时 inert + aria-hidden）
    .appearance-panel__scroll
      ...
      .setting-group × 18        分组设置
      .appearance-panel__footer  状态提示 + 恢复默认
```

十八组设置依次是：视觉风格、默认设置、外观模式、最近文章、最近笔记、PDF 附件、导航材质、导航模糊、内容材质、内容模糊、下拉框材质、下拉框模糊、背景氛围、背景材质、背景模糊、背景遮罩透明度、主题色混合背景、氛围色。导航/内容/下拉框/背景模糊和背景遮罩共五组滑条；材质为导航/内容/下拉框/背景四条通道。「主题色混合背景」默认开启，与氛围色一样可独立调整，纸媒下禁用，恢复默认时开启。具体作用范围与逐层混色比例见 [视觉系统](visual-system.md#主题色混合背景2026-09-26)。背景氛围六张卡片顺序仍为静谧纯色、主题纯色、极光渐变、暮色都市、夕空町市、自定义。
